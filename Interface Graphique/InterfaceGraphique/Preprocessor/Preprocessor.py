                ...
                for file in tqdm(files, desc=f"Processing {color_space} images"):
                    if file.lower().endswith((".jpg", ".jpeg", ".png")):
                        ...
                        try:
                            ...
                            if color_space in h_image_type:
                                take_first_layer = True
                            else:
                            ...
                            orientation = {
                                filter_name: self.shape_describor.get_norm_and_orientation(image, filter_name, take_first_layer=take_first_layer)[1]
                                if color_space in gray_image_type + h_image_type + indexed_image_type else None
