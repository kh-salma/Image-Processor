                ...
                for file in files:
                    ...
                    if file.lower().endswith((".jpg", ".jpeg", ".png")):
                        ...
                        try:
                            ...
                            #     "blob_lbp_hist": self.texture_describor.get_local_binary_pattern_histogram_blob(self.texture_describor.local_binary_pattern_calculation(converted_image)).tolist()
                            # }
